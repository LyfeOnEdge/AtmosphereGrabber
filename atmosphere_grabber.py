# This script grabs the latest version of the Atmosphere bundle from github
import os, sys, json, shutil, io
from zipfile import ZipFile
import urllib.request

UPDATE_NAME = "Atmosphere"
asset_pattern = [["atmosphere"], ".zip"]
UPDATEURL = "https://api.github.com/repos/Atmosphere-NX/Atmosphere/releases"

print("Atmosphere grabber, using python {}.{}".format(sys.version_info[0],sys.version_info[1]))
